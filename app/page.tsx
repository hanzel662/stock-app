    ...
    <main className="min-h-screen bg-slate-50 p-6 text-slate-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 mb-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <input
              className="border border-slate-300 p-2 rounded font-semibold focus:ring-2 focus:ring-indigo-500"
              placeholder="Nama barang"
              value={name}
              onChange={(e) => setName(e.target.value)}
            />
            ...
            <input
              type="number"
              className="border border-slate-300 p-2 rounded font-bold text-center focus:ring-2 focus:ring-indigo-500"
              placeholder="Stok"
              value={stock}
              onChange={(e) => setStock(Number(e.target.value))}
            />
        ...
        {/* SEARCH */}
        <input
          className="border border-slate-300 p-2 w-full rounded mb-4 font-semibold focus:ring-2 focus:ring-indigo-500"
          placeholder="🔍 Cari nama / SKU"
          value={query}
          onChange={(e) => setQuery(e.target.value)}
        />
                ...
                >
                  ...
                  <td className="p-3 text-center">
                    <input
                      type="number"
                      defaultValue={p.stock}
                      className="w-24 border border-slate-300 rounded text-center font-bold focus:ring-2 focus:ring-indigo-500"
                      onBlur={(e) =>
                        updateStockInput(p.id, Number(e.target.value))
                      }
                    />
